...
from {{cookiecutter.project_slug}}.api.mixins import ApiAuthMixin, BasePermissionsMixin
from {{cookiecutter.project_slug}}.users.serializers import RegisterInputSerializer, RegisterOutputSerializer, ProfileOutputSerializer
